...
let gamethumnail = page.locator("[name='gaming-game_thumbnail']");
console.log(gamethumnail);
await page.locator("gaming-game_thumbnail").shadowRoot.children[0].click();


// await page.evaluate(()=>{

//   const gameThumbnail = document.getElementsByClassName('obg-m-game-search-thumbnail')[0]
// })

// document.getElementsByClassName('obg-m-game-search-thumbnail')[0].getElementsByTagName('gaming-game_thumbnail')[0].shadowRoot.children[0].click()
